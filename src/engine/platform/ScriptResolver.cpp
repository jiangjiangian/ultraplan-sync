...
// P5 step 1: ScriptInput::ResolvePlan and its anonymous-namespace
// support helpers (AxisKeyToward + FindNpc + 6 plan-budget constants)
// lifted out of ScriptInput.cpp into their own TU. This is a class
// member of ScriptInput — only the IMPLEMENTATION lives here. C++
// permits per-file partitioning of class implementations and CMake's
// GLOB picks the new TU up automatically. Zero behaviour change; all
// plan-state mutations (planPc_, planWatchdog_, plan_) and Synth*
