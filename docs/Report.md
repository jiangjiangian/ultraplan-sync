...
<<<<<<< HEAD
一句話：在終年下著冬雨的政大山下校區，一把透明傘的失蹤引發了一整學期的蝴蝶效應。
玩家要在加退選、期中考、運動會、期末考四個節點間穿梭，靠「業力」與「選擇」尋回
屬於自己的傘，走向四種結局之一。
=======
> ***前言***  
> 一開始想做這個遊戲，第一個原因是政大一直下雨，身邊一定要帶把傘，沒有傘很難在這生存；第二個原因是總看到校版上的同學 Po 文說：「傘又不見了」、「我相信你是拿錯傘」等等（所以我都把傘留在身邊，盡量不離 手，目前還沒掉過，非常慶幸～）；第三個原因是這學期實在是太多市集了（真的太多了），當下心中想到的是：「這蠻像薩爾達的驛站或是各種地圖上的市集，感覺可以拿來做素材～」。總之，經過頭腦風暴後，很多點子如雨後春筍般冒出來，我趕緊問 Gemini 這究竟要怎麼具體實作和發揮，有什麼參考資料和論文，最初看到一篇是 [WHAT-IF: Exploring Branching Narratives by Meta-Prompting Large Language Models](https://arxiv.org/abs/2412.10582)，作者提出一個名為 WHAT-IF 的系統，利用零樣本元提示（Zero-shot meta-prompting）技術，將既有的線性故事自動轉化為具備多重選擇的互動式分支劇情（Branching narratives），並透過圖形結構（Graph）來確保故事的連貫性與邏輯。這聽起來非常感覺很簡單（？），Gemini 幫我設計了第一份文件 [遊戲企劃與敘事架構](../遊戲企劃與敘事架構.md)，看完以後覺得很不錯，東西很多都是我想要的，再加上學過的 C++ 語法（類別 -> 動態多型, 模板 -> 靜態多型） 與 modern C++ （std::move(), std::unique_ptr(T) 等智慧指標），都是很值得寫入遊戲實作的。  
> 不過，一開始當我跟 AI 講出我的需求，他起初是都能實踐的，但當 codebase 開始龐大，檔案一多，context window 無法容納過多的 input 導致他開始失憶，中間過程其實有一度是失控的（到處亂改、生出一堆不避必要的東西），我知道這是我駕馭（harness）失敗所導致的。我也因此上網查了許多與 AI 協作的正確方法，可以說領悟到三點：  
> 1. 對於一個專案（尤其大型專案），一開始一定要有非常清楚的「計畫」，以及建立一個 graph 做檔案索引
> 2. 真正開始前一定要建立一個「團隊」，打造一隻專屬於這個專案的各種「專家」，各自負責什麼
> 3. 出 bug 時一定要人類具體指出來，並且用條列式的「詳細」文字敘述，請他們找出哪一份檔案與相依的檔案受到影響  

> 後來按照這樣的原則，一切都拉回正軌，這也給了我了一個很重要的啟發，要與 AI 協作不只要有很多 domain-knowledge ，還要有一種與工作夥伴團隊合作的精神，必須要具體密集的討論分工細節才能持續推動專案往前，否則真的只是讓他們像無頭蒼蠅般打轉，未來和 AI 工作會像是成為同等地位的「夥伴」（最終決策者當然還是人類），組成一支由人類與 AI 的團隊。

**一句話**：  
在終年下著冬雨的政大山下校區，一把透明傘的失蹤，引發一整學期的蝴蝶效應；玩家要在加退選、期中考、運動會、期末考四個節點間穿梭，靠「業力」與「選擇」尋回屬於自己的傘，走向四種結局之一。
>>>>>>> 2f70590 (docs(report): enhance project understanding section with detailed insights and collaboration principles)
...
而我學到的，是即使「出一張嘴」，我也在過程裡把 move 語意、CRTP、MVC 的責任邊界、
為什麼不要 `dynamic_cast` 這些東西，從「聽過」變成「能對它的實作提出意見」。對我來說，
這才是這份作業最大的收穫——重點不是我會不會背 C++ 語法，而是我能不能判斷一個架構
好不好、並要求把它做到位。

<<<<<<< HEAD
這不是我一個字一個字打出來的，但這個專案的品味、那條「什麼叫做好」的標準、以及把它
一路修到對齊的耐心，是我的。我相信在 AI 時代，這種能當導演、能做決策、能堅持品質的
能力，和會不會親手寫程式一樣重要，甚至更重要。
=======
**結語**   
這個專案的品味、那條「什麼叫做好」的標準、以及把它一路修到對齊的耐心，是我的。我相信在 AI 時代，這種「能當導演、能做決策、能堅持品質」的能力，和會不會親手寫程式一樣重要——甚至更重要。
>>>>>>> 2f70590 (docs(report): enhance project understanding section with detailed insights and collaboration principles)
